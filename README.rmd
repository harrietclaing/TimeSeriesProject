...
```{r, echo = FALSE}
VECModelNew <- ca.jo(groupedVAR, type="eigen", K=2, ecdet="trend", spec="longrun") #incl linear trend as per paper
VARModelNew <- vec2var(VECModelNew, r=2)

M_IRF <- irf(VARModelNew, impulse = "WorldOilPrice", response = "MonetaryAggregate",
             n.ahead = 8, ortho = FALSE, runs = 1000)
IR_IRF <- irf(VARModelNew, impulse = "WorldOilPrice", response = "InterestRate",
             n.ahead = 8, ortho = FALSE, runs = 1000)
GDP_IRF <- irf(VARModelNew, impulse = "WorldOilPrice", response = "RealGDP",
             n.ahead = 8, ortho = FALSE, runs = 1000)
I_IRF <- irf(VARModelNew, impulse = "WorldOilPrice", response = "Inflation",
             n.ahead = 8, ortho = FALSE, runs = 1000)
ER_IRF <- irf(VARModelNew, impulse = "WorldOilPrice", response = "ExchangeRate",
             n.ahead = 8, ortho = FALSE, runs = 1000)
M <- plot(M_IRF)
I <- plot(IR_IRF)
G <- plot(GDP_IRF)
...
```{r, echo = FALSE}
VECModel <- VECM(cointanalysisVAR, lag=4, r=2, estim="ML")
summary(VECModel)
```
#Find VECM residuals
```{r, echo=FALSE}
